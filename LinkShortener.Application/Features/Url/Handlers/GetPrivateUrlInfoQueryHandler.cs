...
{
    public class GetPrivateUrlInfoQueryHandler : IQueryHandler<GetPrivateUrlInfoQuery, GetUrlInfoResponse?>
    {
        ...
        public async Task<GetUrlInfoResponse?> HandleAsync(GetPrivateUrlInfoQuery request, CancellationToken cancellationToken)
        {
